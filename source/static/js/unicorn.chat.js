...
$(document).ready(function(){
	...
	setTimeout(function(){
			add_message('Neytiri','admin/img/demo/av2.jpg','I have a problem. My computer not work!')
		},'6000');
	setTimeout(function(){
			add_message('Cartoon Man','admin/img/demo/av3.jpg','Turn off and turn on your computer then see result.')
		},'11000');
	setTimeout(function(){
